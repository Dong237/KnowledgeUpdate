...
def _chunking_by_token_size(content: str, tokenizer: AutoTokenizer, overlap_token_size=64, max_token_size=512):
...
def _generate_qa_pairs_from_one_txt_file(data_path: str, data_name: str, model_name_or_path: str,
                                         qa_amount_per_fact: int, role_amount_per_fact: int, 
                                         chunk_size_by_token: int) -> List[dict]:
